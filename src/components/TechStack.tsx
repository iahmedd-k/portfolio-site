        ...
        <div className="mt-16 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {[
              ...
              "Firebase", "Supabase", "Stripe", "Socket.io", "Jest", 
              "Cypress", "Webpack", "Vite", "Sass", "Bootstrap"
            ].map((skill, index) => (
              <span 
                key={skill}
                className="glass glass-hover px-4 py-2 rounded-full text-gray-300 text-sm font-medium transition-all duration-300 hover:scale-105 hover:text-cyan-400"
